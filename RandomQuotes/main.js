...
function Change(){
    ...
    var rnmColorNumb=Math.floor(Math.random()*12);
    document.body.style.backgroundColor=colors[rnmColorNumb];
...
function ShareTweet(){
    ...
    window.location.href='https://twitter.com/intent/tweet?hashtags=szelaal&text='+encodeURIComponent('"'+text+'"');
}
GetQuotes();